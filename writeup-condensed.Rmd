...
**Figure 6: Additional Survival Curves for Race of Incarcerated Individual**

```{r addtl-survival-curves, fig.height=2.5}
...
**Figure 7: Kaplan-Meier Residual Plots of AFT Model Candidates**
...
**Table 6: AIC and BIC for Log-normal AFT Models by Race Encoding Method**
...
**Table 7: Full Primary Survival Analysis Results**
...
**Figure 8: Additional Survival Curves for Race of Victim**

```{r addtl-survival-curves-victim, fig.height=2.5}
...
**Table 9: AIC and BIC for Log-normal AFT Models Including Victim Traits by Race Encoding Method**
...
**Table 10: Full Primary Survival Analysis Results**
