...
Our next goal is to observe whether an individual's race is associated with jail time, and if an association does exist, what is the effect size of race on pretrial detention.
